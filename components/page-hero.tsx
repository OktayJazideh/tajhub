export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-gold/10 pb-20 pt-40 lg:pt-44">
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-0 h-[460px] w-[820px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,oklch(0.8_0.14_80/0.1),transparent_70%)] blur-3xl"
      />
