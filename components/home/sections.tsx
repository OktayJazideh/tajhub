...
export function EcosystemSection() {
  return (
    <section
      id="ecosystem"
      className="relative overflow-x-clip scroll-mt-24 border-t border-gold/10 py-16 lg:py-20"
    >
      <div
        aria-hidden
...
export function ClosingCta() {
  return (
    <section className="relative overflow-x-clip border-t border-gold/10 py-16 lg:py-24">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-[420px] max-w-[820px] w-full rounded-full bg-[radial-gradient(circle,oklch(0.8_0.14_80/0.12),transparent_70%)] blur-3xl"
      />
