...
export function Hero() {
  return (
    <section className="relative overflow-x-clip">
      {/* ambient glow — translate-x-1/3 keeps blur inside viewport on mobile */}
      <div
        aria-hidden
      ...
      <div className="mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-6 pb-24 pt-32 lg:grid-cols-[1fr_1.15fr] lg:px-10 lg:pt-28">
        ...
        <div className="order-2 flex flex-col items-start lg:order-1">
          ...
          >
            TAJ HUB تنها یک نرم‌افزار نیست. سیستم‌جامعی است که وضعیت صفر، نگهداری پیشگیرانه، حافظه ساختمان، مدیریت ساکنان و عملیات ساختمان را در یک اکوسیستم هوشمند به هم متصل می‌کند.
          </p>
